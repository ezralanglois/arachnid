...
class Ui_ProjectWizard(object):
    def setupUi(self, ProjectWizard):
        ...
        self.particleSizeDoubleSpinBox = QtGui.QDoubleSpinBox(self.groupBox_4)
        self.particleSizeDoubleSpinBox.setMaximum(10000.0)
        self.particleSizeDoubleSpinBox.setObjectName("particleSizeDoubleSpinBox")
        self.gridLayout.addWidget(self.particleSizeDoubleSpinBox, 0, 1, 1, 1)
        self.particleDiameterPixelLabel = QtGui.QLabel(self.groupBox_4)
        self.particleDiameterPixelLabel.setObjectName("particleDiameterPixelLabel")
        self.gridLayout.addWidget(self.particleDiameterPixelLabel, 0, 2, 1, 1)
        self.label_21 = QtGui.QLabel(self.groupBox_4)
        self.label_21.setObjectName("label_21")
        self.gridLayout.addWidget(self.label_21, 1, 0, 1, 1)
        self.windowAngstromDoubleSpinBox = QtGui.QDoubleSpinBox(self.groupBox_4)
        self.windowAngstromDoubleSpinBox.setMaximum(10000.0)
        self.windowAngstromDoubleSpinBox.setObjectName("windowAngstromDoubleSpinBox")
        self.gridLayout.addWidget(self.windowAngstromDoubleSpinBox, 1, 1, 1, 1)
        self.windowWidthAnstromsLabel = QtGui.QLabel(self.groupBox_4)
        self.windowWidthAnstromsLabel.setObjectName("windowWidthAnstromsLabel")
        self.gridLayout.addWidget(self.windowWidthAnstromsLabel, 1, 2, 1, 1)
        self.label = QtGui.QLabel(self.groupBox_4)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 2, 0, 1, 1)
        self.maskDiameterDoubleSpinBox = QtGui.QDoubleSpinBox(self.groupBox_4)
        self.maskDiameterDoubleSpinBox.setMaximum(10000.0)
        self.maskDiameterDoubleSpinBox.setObjectName("maskDiameterDoubleSpinBox")
        self.gridLayout.addWidget(self.maskDiameterDoubleSpinBox, 2, 1, 1, 1)
        self.maskDiameterPixelLabel = QtGui.QLabel(self.groupBox_4)
        self.maskDiameterPixelLabel.setObjectName("maskDiameterPixelLabel")
        self.gridLayout.addWidget(self.maskDiameterPixelLabel, 2, 2, 1, 1)
    ...
    def retranslateUi(self, ProjectWizard):
        ...
        self.label_9.setText(QtGui.QApplication.translate("ProjectWizard", "Particle Diameter (A)", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.particleDiameterPixelLabel.setText(QtGui.QApplication.translate("ProjectWizard", "0 (Px)", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_21.setText(QtGui.QApplication.translate("ProjectWizard", "Window Width (A)", None, QtGui.QApplication.UnicodeUTF8))
        self.windowAngstromDoubleSpinBox.setToolTip(QtGui.QApplication.translate("ProjectWizard", "Diameter of mask in angstroms", None, QtGui.QApplication.UnicodeUTF8))
        self.windowWidthAnstromsLabel.setText(QtGui.QApplication.translate("ProjectWizard", "0 (Px)", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("ProjectWizard", "Mask Diameter (A)", None, QtGui.QApplication.UnicodeUTF8))
        self.maskDiameterDoubleSpinBox.setToolTip(QtGui.QApplication.translate("ProjectWizard", "Diameter of mask in angstroms", None, QtGui.QApplication.UnicodeUTF8))
        self.maskDiameterPixelLabel.setText(QtGui.QApplication.translate("ProjectWizard", "0 (Px)", None, QtGui.QApplication.UnicodeUTF8))
