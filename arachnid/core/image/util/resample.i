...
%apply (std::complex<float>* INPLACE_ARRAY3, int DIM1, int DIM2, int DIM3) {(std::complex<float>* vol, dsize_type vol_r, dsize_type vol_c, dsize_type vol_d)};
%apply (std::complex<float>* INPLACE_ARRAY3, int DIM1, int DIM2, int DIM3) {(std::complex<float>* vout, dsize_type vout_r, dsize_type vout_c, dsize_type vout_d)};
