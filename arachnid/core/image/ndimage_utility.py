...
def peakdetect(y_axis, x_axis = None, lookahead = 300, delta=0):
    ...
    .. note::
        ...
        Adopted from: https://gist.github.com/sixtenbe/1178136
        
        Which was originally, converted from/based on a MATLAB script at: 
    ...
    return -- two lists [max_peaks, min_peaks] containing the positive and
        ...
        to get the average peak value do: numpy.mean(max_peaks, 0)[1] on the
