# -*- coding: utf-8 -*-
#
# AutoPart documentation build configuration file, created by
# sphinx-quickstart on Wed Jan 20 15:29:37 2010.
#
...
# for source files.
exclude_trees = ['resources', 'git-hooks', 'build', 'dist', 'docs/themes', 'docs/templates', 'docs/images', 'docs/includes']#, 'arachnid/core/gui/icons']
...
# pixels large.
html_favicon = "docs/images/icons/logo/favicon.ico"
...
latex_documents = [
  ('index', 'arachnid.tex', arachnid.__project__+' Documentation',
   arachnid.__author__ , 'manual'),
]
